...
namespace commercio.sdk
{
    public class MembershipHelper
    {
        ...
        public static async Task<TransactionResult> buyMembership(MembershipType membershipType, Wallet wallet, StdFee fee = null, BroadcastingMode mode = BroadcastingMode.SYNC,string stp="")
        {
            BuyMembership buyMembership = BuyMembershipHelper.fromWallet(wallet, membershipType, stp);
